...
D_op = optim.Adam(nn_D.parameters(), lr=1e-5) #RMSprop, maybe smaller lrs. 10^-3, 10^-4
...
np.save("/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/Data/vanilla.npy",  fake)
torch.save(nn_G.state_dict(), '/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/Trained GANs/vanilla.h5')
...
plt.savefig('/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/figs/vanilla.eps', bbox_inches='tight')
...
plt.xlabel('x')
plt.ylabel('y')
plt.savefig('/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/figs/vanilla2.eps', bbox_inches='tight')
#plt.legend()
plt.show()
