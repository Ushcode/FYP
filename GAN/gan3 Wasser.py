...
D_op = optim.RMSprop(nn_D.parameters(), lr=5e-5) #RMSprop, maybe smaller lrs. 10^-3, 10^-4
G_op = optim.RMSprop(nn_G.parameters(), lr=5e-5)
...
plt.savefig('/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/figs/Wasser.eps', bbox_inches='tight')

np.save("/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/Data/Wassergan1UNIF.npy",  fake_data.detach().numpy())
...
plt.xlabel('x')
plt.ylabel('y')
plt.savefig('/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/figs/wassers.eps', bbox_inches='tight')
#plt.legend()
plt.show()
