...
criterion = nn.L1Loss() # maybe change to nn.CrossEntropyLoss()
D_op = optim.RMSprop(nn_D.parameters(), lr=1e-6) #RMSprop, maybe smaller lrs. 10^-3, 10^-4
G_op = optim.RMSprop(nn_G.parameters(), lr=1e-5)
...
#       D - Train on Fake Data
        latent_vector = torch.empty(batch_size, Z).uniform_(0, 1) # latent vector, zero centred unit variance Gaussian Distribution
...
#       G - Train
       ...
       # try new latent
        latent_vector = torch.empty(batch_size, Z).uniform_(0, 1)
        G_op.zero_grad()
        fake_data = nn_G(latent_vector)
...
np.save("/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/Data/wasser.npy",  fake)
torch.save(nn_G.state_dict(), '/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/Trained GANs/wasser.h5')
...
plt.savefig('/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/figs/maybe.eps', bbox_inches='tight')

np.save("/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/Data/Wassergan1UNIF2.npy",  fake_data.detach().numpy())
torch.save(nn_G.state_dict(), '/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/Trained GANs/wasser.h5')
...
plt.xlabel('x')
plt.ylabel('y')
plt.savefig('/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/figs/wasserloss2.eps', bbox_inches='tight')
#plt.legend()
plt.show()
