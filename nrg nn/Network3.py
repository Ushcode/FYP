...
"""
This Network is trained with 10,000 points generated by TASK3. The data is NORMALISED before splitting into training, val, test sets.
"""
plum = '#A16E83'
blu = '#206B99'
...
datalist = np.load("/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/Data/datalist3.npy")
nrglist = np.load("/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/Data/nrglist3.npy")
...
callbacks = [EarlyStopping(patience=10, verbose=1), ModelCheckpoint(filepath='/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/Trained Networks/model3.h5', save_best_only=True, verbose=1)]
...
plt.yscale('log')
plt.xlabel('Epoch')
plt.savefig('/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/figs/loss3.eps', bbox_inches='tight')
plt.legend()
...
plt.savefig('/Users/Oisin/Documents/Theoretical Physics/PROJECT/CODE/figs/prediction3.eps', bbox_inches='tight')

plt.show()

# Translation test
#
#datalist_scaled =  datalist * 2
#nrglist =
